    ...
    private void display(Player player)
    {
        ...
        for(Point3D point : outline)
        {
            ...
            ParticleEffect.REDSTONE.display(new ParticleEffect.OrdinaryColor(0, 0, 0),
                    new Location(playerWorld, rotated.x + x, rotated.y + y, rotated.z +z),
                    50);
        ...
        for(Point3D point : fill)
        {
            ...
            ParticleEffect.REDSTONE.display(new ParticleEffect.OrdinaryColor(255,0,0), new Location(playerWorld, rotated.x + x, rotated.y + y, rotated.z +z), 100f);
